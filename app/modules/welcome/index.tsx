...
export function Welcome() {
  ...
  const conceptOpacity = useTransform(conceptProgress, [0, 0.6, 1], [0, 0, 1]);
  ...
  const menuOpacity = useTransform(menuProgress, [0, 0.6, 1], [0, 0, 1]);
  ...
  const mapOpacity = useTransform(mapProgress, [0, 0.6, 1], [0, 0, 1]);
